...
//var myApp = angular.module('myApp', []); myApp.controller('bprovidersController', ['$scope', '$http', function($scope, $http) { console.log("Hello World from controller"); }]);
//var xx= [{question:"koko",answer:""}];

var uss = new business({bproviderid:'15',businessName:'Test',location:'Cairo',phone:01971,ratingsGiven:[],rating:9.6,announcements:[],reviews:[],description:'teteghdj',profilepicture:'http://images5.fanpop.com/image/photos/30900000/beautiful-pic-different-beautiful-pictures-30958249-500-375.jpg',info:'Test For Sprint 2',questions:[],isApproved:true,services:[]});
uss.save(function(err,result){console.log(result)});
