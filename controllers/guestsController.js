...
searchBusinessUpdated: function(req, res, next) {
  var search = req.body.businessName
    business.find({ businessName: new RegExp(req.search.businessName, "i") }).sort({ rating: "descending" })
        ...
        .exec((err, buisnessName) => {
           ...
           if(err) return res.json({success:false, msg:'Invalid parameters'});
             ...
             return res.json( {
                ...
                search: req.search.businessName
            });
